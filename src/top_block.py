...
# Title: Top Block
# Generated: Fri Mar  1 07:45:50 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._val2_range = Range(0, 1000, 0.1, 5, 200)
        self._val2_win = RangeWidget(self._val2_range, self.set_val2, 'high', "counter_slider", float)
        self.top_layout.addWidget(self._val2_win)
        self._val_range = Range(1, 1000, 0.1, 5, 200)
        self._val_win = RangeWidget(self._val_range, self.set_val, 'low', "counter_slider", float)
        self.top_layout.addWidget(self._val_win)
        self.sattools_asm_golay_decoder_0 = sattools.asm_golay_decoder(9600, '{:b}'.format(0x930b51de), 3, True, False, False)
        ...
        self.low_pass_filter_1 = filter.fir_filter_fff(1, firdes.low_pass(
        	1, 1996800, 9600, 4800, firdes.WIN_HAMMING, 6.76))
        self.freq_xlating_fir_filter_xxx_0_0 = filter.freq_xlating_fir_filter_ccf(1, (firdes.low_pass_2(1,1996800,9600,300,12.5)), 0, 1996800)
        self.digital_clock_recovery_mm_xx_0 = digital.clock_recovery_mm_ff(208, 0.01, 0, 0.01, 0.005)
        self.digital_binary_slicer_fb_0 = digital.binary_slicer_fb()
        self.blocks_unpacked_to_packed_xx_0 = blocks.unpacked_to_packed_bb(1, gr.GR_LSB_FIRST)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, 1996800,True)
        self.blocks_threshold_ff_0 = blocks.threshold_ff(-val, val2, 0)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff((10, ))
        self.blocks_message_debug_0 = blocks.message_debug()
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/miguel/gnuradio/beacon_UPAEP_centered_rate_2M', True)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/home/miguel/gnuradio/intento_22.02.19/data_slide.txt', False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_float*1, '/home/miguel/gnuradio/intento_22.02.19/data_demod.txt', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/miguel/gnuradio/intento_22.02.19/data_clock_recovery.txt', False)
        ...
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf(1996800/(2*math.pi*16320/8.0))

        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.sattools_asm_golay_decoder_0, 'out'), (self.blocks_message_debug_0, 'print_pdu'))
    ...
    def set_val2(self, val2):
        self.val2 = val2
        self.blocks_threshold_ff_0.set_hi(self.val2)
    ...
    def set_val(self, val):
        self.val = val
        self.blocks_threshold_ff_0.set_lo(-self.val)
